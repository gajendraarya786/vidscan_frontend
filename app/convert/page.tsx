...
export default function ConvertPage() {
  ...
  /* ─── cleanup ─── */
  useEffect(() => () => {
    // no-op, modal handles its own cleanup
  }, []);
      ...
      <div className="mx-auto max-w-2xl px-4 py-10 space-y-6">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
          ...
          <div className="p-6 space-y-5">
            ...
            {/* ══ RECORD TAB ══ */}
            {tab === "record" && (
              <div className="flex min-h-[180px] flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed border-gray-300 px-6 py-10 text-center bg-gray-50/50">
                {!file ? (
                  <>
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-pink-100 text-3xl">
                      📷
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-400">
                        Use your mobile camera or webcam to scan pages
                      </p>
                    </div>
                    <button
                      onClick={() => setIsCameraOpen(true)}
                      className="inline-flex items-center gap-2 rounded-lg bg-red-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-red-500 shadow-md shadow-red-500/20 mt-2"
                    >
